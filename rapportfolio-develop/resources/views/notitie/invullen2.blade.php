...
<div class="row">
    <div class="col s12 m12 l12">
        <div style="padding-bottom: 100px" class="card-panel white">
            ...
            <form action="{{route('notinsert2', $leerling->leerlingid)}}" method="post">
                {{csrf_field()}}
                        ...
                        <td>
                            <div class="row">
                                <div class="input-field col s12 m12 l12">
                                    <textarea id="textarea2" name="notitie" class="materialize-textarea" data-length="120" required></textarea>
