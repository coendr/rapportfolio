...
@section('content')
    <div class="row">
        <div class="col s12 m12 l12">
            ...
            <span class="white-text center-align"><h3>Opmerking Invullen </h3><br><h5>Rapport 2</h5>
            </span>
                        </div>
                    </div>
                </div>

                <form action="{{route('notitieinvullenleerling2', $leerling->leerlingid)}}" method="post">
                    {{csrf_field()}}
